...
#### WARNING: this script uses an autoupdater. If you're not down for this, switch your script to use `https://github.com/SteamGame/SteamMinigame/raw/master/autoPlay.noUpdate.user.js` and update manually through Greasemonkey/Tampermonkey like normal. ####

## Installation ##

### [Tampermonkey](https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo) ###

1. Visit https://github.com/SteamGame/SteamMinigame/raw/master/autoPlay.user.js
2. When the editor has loaded, click `Install` (*NOT* `Process with Chrome`).

### [Greasemonkey](https://addons.mozilla.org/en-US/firefox/addon/greasemonkey/) ###

1. Navigate to https://github.com/SteamGame/SteamMinigame/raw/master/autoPlay.user.js
 ...
 * If you're not down for this, switch your script to use `https://github.com/SteamGame/SteamMinigame/raw/master/autoPlay.noUpdate.user.js` and update manually through Greasemonkey/Tampermonkey like normal.
...
##### Chrome #####
1. Open https://raw.githubusercontent.com/SteamGame/SteamMinigame/master/autoplay.noUpdate.user.js
2. Select All, Copy.
